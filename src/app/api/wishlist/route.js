...
/**
 * Handles GET requests to retrieve a user's wishlist.
 * @param {Request} request The incoming request object.
 * @returns {NextResponse} The JSON response containing the wishlist.
 */
  ...
  try {
    ...
    if (!wishlist) {
      return NextResponse.json(
        { error: "Wishlist not found for this user." },
        { status: 404 }
      );
    }
