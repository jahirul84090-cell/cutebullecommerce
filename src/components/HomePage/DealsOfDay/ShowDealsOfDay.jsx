...
const FeaturedProductCard = ({
  ...
  return (
    <Card className="relative p-6 flex flex-col md:flex-row gap-6 border border-red-500">
            ...
            <TooltipTrigger asChild>
              <Link href={`/products/${product?.id}`} passHref>
                <Button
                  variant="ghost"
                  size="icon"
                  className="absolute top-2 right-2 rounded-full bg-white/50 backdrop-blur-sm hover:bg-white transition-colors duration-200"
          ...
          {isOutOfStock ? (
            ...
            <>
              <Link href={`/${product?.slug}`} passHref>
                <Button
                  variant="outline"
                  className="flex-1 w-full flex items-center justify-center space-x-2 rounded-full"
                  onClick={(e) => e.stopPropagation()}
                >
                ...
                isInCart ? (
                  <div className="flex-1 flex bg-gray-200 p-2 rounded-3xl items-center justify-between space-x-4">
                    <Button
                      ...
                      className="rounded-full border-gray-300 text-purple-600 hover:bg-purple-50 hover:border-purple-600"
                      disabled={
                  ...
                  <Button
                    className={`flex-1 w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-2 rounded-full flex items-center justify-center space-x-2 `}
