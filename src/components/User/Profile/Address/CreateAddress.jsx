    ...
    <div className="container mx-auto p-4 sm:p-6 lg:p-12 font-sans bg-gray-50 min-h-screen text-gray-900">
      <div className="max-w-4xl mx-auto">
        <Card className="shadow-lg border-gray-200 rounded-2xl overflow-hidden">
          <CardHeader className="bg-purple-600 p-6 sm:p-8 flex items-center justify-between">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-gray-300 rounded-lg focus-visible:ring-purple-500 transition-colors"
              ...
              <div className="flex items-center justify-end space-x-2 pt-4">
                ...
                <Switch
                  ...
                  className="data-[state=checked]:bg-purple-600 transition-colors"
                />
              </div>
              <div className="flex justify-end space-x-3 pt-6">
                ...
                <Button
                  type="submit"
                  disabled={submitting}
                  className="bg-purple-600 hover:bg-purple-700 text-white rounded-lg font-medium shadow-sm transition-colors"
                >
                  {submitting ? (
