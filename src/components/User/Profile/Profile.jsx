            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              <div className="flex flex-col md:flex-row gap-8 items-center md:items-start">
                ...
                <div className="flex flex-col items-center">
                  ...
                  <Label
                    htmlFor="image"
                    className="mt-4 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full shadow-sm text-white bg-purple-600 hover:bg-purple-700 transition-colors cursor-pointer"
                  >
                ...
                <div className="flex-1 space-y-6 w-full">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className="border-gray-300 focus:ring-purple-500 rounded-full shadow-sm"
                    />
                    {errors.name && (
                  ...
                  <Button
                    type="submit"
                    disabled={submitting}
                    className="h-11 px-7 rounded-full bg-purple-600 hover:bg-purple-700 text-white font-semibold shadow-lg transition-colors"
                  >
                    {submitting ? (
          ...
          <CardContent className="p-6 sm:p-8">
            <div className="flex flex-col md:flex-row gap-4 mb-8 items-center justify-between">
              <Input
                ...
                className="w-full md:w-80 border-gray-300 focus:ring-purple-500 rounded-full shadow-sm"
              />
              <Link href="/profile/address/add" className="w-full md:w-auto">
                <Button className="w-full h-11 px-7 rounded-full bg-purple-600 hover:bg-purple-700 text-white font-semibold shadow-lg transition-colors">
                ...
                {addresses.map((address) => (
                  ...
                  >
                    <CardContent className="p-6">
                      ...
                      {address.isDefault && (
                        <span className="mt-4 inline-block px-3 py-1 text-xs font-bold text-purple-600 bg-purple-50 rounded-full">
                          Default Address
                        </span>
                      )}
                    </CardContent>
