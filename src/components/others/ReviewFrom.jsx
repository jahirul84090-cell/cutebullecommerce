      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex space-x-2 mt-2">
            {[1, 2, 3, 4, 5].map((star) => (
              <svg
                ...
                className={`h-8 w-8 cursor-pointer transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 rounded-full ${
                  star <= rating
        ...
        <div>
          ...
          <input
            ...
            } rounded-md shadow-sm p-3 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-base transition-all duration-200`}
        ...
        <div>
          ...
          <textarea
            id="review-text"
            rows="6"
            className="mt-2 block w-full border border-gray-300 rounded-md shadow-sm p-3 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 text-base transition-all duration-200"
          ...
          <div className="mt-3 grid grid-cols-2 sm:grid-cols-5 gap-3">
            {uploadedImages.map((image, index) => (
              <div key={index} className="relative w-full h-20">
                ...
                {!image.uploading && (
                  <button
                    type="button"
                    className="absolute -top-2 -right-2 w-6 h-6 bg-black bg-opacity-60 text-white rounded-full flex items-center justify-center hover:bg-black focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200"
            ...
            {uploadedImages.length < 5 && (
              <label
                ...
                className="flex flex-col items-center justify-center w-full h-20 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer transition-colors duration-200 hover:bg-gray-50 focus-within:ring-2 focus-within:ring-purple-500"
              >
                <svg
        ...
        <div className="flex justify-end space-x-3 mt-6">
          <button
            type="submit"
            className={`relative bg-purple-600 text-white hover:bg-purple-700 rounded-full text-base px-6 py-3 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-500 ${
