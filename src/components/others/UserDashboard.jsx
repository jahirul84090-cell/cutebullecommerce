        ...
        <div className="max-w-7xl mx-auto">
              ...
              {recentOrders.length > 0 ? (
                ...
                <div className="py-10 text-center text-gray-500">
                  ...
                  <Link href="/products" passHref>
                    <Button className="mt-4 rounded-full bg-purple-600 hover:bg-purple-700 text-white font-semibold px-6">
                      Start Shopping
                    </Button>
                  </Link>
                </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <Link href="/profile" passHref>
              <Button
                asChild
                className="w-full h-16 rounded-2xl bg-white text-purple-600 border border-purple-200 hover:bg-purple-50 shadow-md transition-colors flex items-center justify-center text-lg font-semibold"
              >
